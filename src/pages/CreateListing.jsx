  ...
  return (
    <main className='max-w-md px-2 mx-auto'>
      ...
      <form action="" onSubmit={onSubmit}>
        ...
        <div className='flex gap-6 mt-6'>
          <div className='w-full'>
            ...
            <input type="number" id='bedrooms' value={bedrooms} onChange={onChange} min='1' max='20' required
              className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:border-slate-600 text-center'
            />
          </div>
          <div className='w-full'>
        ...
        {!geolocationEnabled && (
          <div className="flex space-x-6 justify-start my-6">
            <div className="">
